...
%GXX% -std=c++0x -o %TARGET% %SOURCES% -lm -O2 -g -Wl,-e,__entry -Wno-unused-result -Ilibinteractive/Main
IF !ERRORLEVEL! NEQ 0 EXIT /B !ERRORLEVEL!
ECHO DONE
)

SET TARGET=libinteractive\atrapando\atrapando.exe
SET SOURCES=atrapando.cpp libinteractive\atrapando\atrapando_entry.cpp
call:recompile %TARGET% %SOURCES%
IF "%RECOMPILE%" == "1" (
<NUL SET /p elidenewline=Compiling %TARGET%... 
%GXX% -std=c++0x -o %TARGET% %SOURCES% -lm -O2 -g  -Wno-unused-result -Ilibinteractive/atrapando
IF !ERRORLEVEL! NEQ 0 EXIT /B !ERRORLEVEL!
ECHO DONE
)

SET TARGET=libinteractive\atrapando\atrapando_debug.exe
SET SOURCES=atrapando.cpp libinteractive\atrapando\atrapando_entry.cpp
call:recompile %TARGET% %SOURCES%
IF "%RECOMPILE%" == "1" (
<NUL SET /p elidenewline=Compiling %TARGET%... 
%GXX% -std=c++0x -o %TARGET% %SOURCES% -lm -g  -Wno-unused-result -Ilibinteractive/atrapando
IF !ERRORLEVEL! NEQ 0 EXIT /B !ERRORLEVEL!
ECHO DONE
)
