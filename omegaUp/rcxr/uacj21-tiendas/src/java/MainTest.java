...
public class MainTest {
  ...
  @Test
  public void test() {
    InputStream input = this.getClass().getResourceAsStream("test" + param + ".in");
    System.setIn(input);
  ...
  private String getExpected() {
    ...
    Scanner scanner = new Scanner(this.getClass().getResourceAsStream("test" + param + ".out")).useDelimiter("\\A");
