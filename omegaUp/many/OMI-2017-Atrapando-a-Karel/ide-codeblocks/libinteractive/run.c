...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_atrapando_out", "\\\\.\\pipe\\libinteractive_atrapando_atrapando_out" },
	{ "\\\\.\\pipe\\libinteractive_atrapando_atrapando_in", "\\\\.\\pipe\\libinteractive_Main_atrapando_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\atrapando\\atrapando.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\atrapando\\atrapando_debug.exe\"",
};
